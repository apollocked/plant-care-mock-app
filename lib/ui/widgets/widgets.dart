...
class PlantImage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Image(image: AssetImage('assets/plant.png'), height: 400);
  }
}
            ...
            child: ElevatedButton(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Text('Plant Food', style: TextStyle(fontSize: 15)),
                ],
              ),
            ),
          ),
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              FaIcon(FontAwesomeIcons.tint, size: 20, color: Colors.teal[50]),
              const SizedBox(width: 3),
              const Text(
                '80%',
                style: TextStyle(fontSize: 20, color: Colors.white),
